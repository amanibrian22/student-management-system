...
<head>
    ...
    <title>Add Comment - AcademiTrack</title>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <form action="{{ route('comments.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="student_name" id="student_name" class="w-full p-2 border rounded-lg text-sm" value="{{ old('student_name') }}" required>
                            @error('student_name')
                        ...
                        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 text-sm">Create Comment</button>
