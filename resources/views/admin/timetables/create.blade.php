                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <form action="{{ route('timetables.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="course_code" id="course_code" class="w-full p-2 border rounded-lg text-sm" required>
                            @error('course_code')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="time" name="start_time" id="start_time" class="w-full p-2 border rounded-lg text-sm" required>
                            @error('start_time')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="time" name="end_time" id="end_time" class="w-full p-2 border rounded-lg text-sm" required>
                            @error('end_time')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="location" id="location" class="w-full p-2 border rounded-lg text-sm" required>
                            @error('location')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-sm">Create Timetable</button>
                    </form>
                </div>
            </main>
        </div>
