                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <form action="{{ route('announcements.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="w-full p-2 border rounded-lg text-sm" required>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="content" class="w-full p-2 border rounded-lg text-sm" rows="5" required></textarea>
                            @error('content')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="date" name="posted_date" id="posted_date" class="w-full p-2 border rounded-lg text-sm" required>
                            @error('posted_date')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
