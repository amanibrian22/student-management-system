                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    <form action="{{ route('timetables.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="subject" id="subject" class="w-full p-2 border rounded-lg text-sm" value="{{ old('subject') }}" required>
                            @error('subject')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="time" name="start_time" id="start_time" class="w-full p-2 border rounded-lg text-sm" value="{{ old('start_time') }}" required>
                            @error('start_time')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="time" name="end_time" id="end_time" class="w-full p-2 border rounded-lg text-sm" value="{{ old('end_time') }}" required>
                            @error('end_time')
                                <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
